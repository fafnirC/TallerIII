...
function preload() 
{
  ...
  table = loadTable("assets/data_1.csv", "header");
}
...
function draw() {
  ...
  fill(0);
  textSize(20);
  text("Estadisticas del",1200,135);
  text(" Usuario Final",1200,165);
  ...
  if (millis() > sync) {
    show.push(new Firework(random(1000),random(height))); 
  ...
  if (millis() > sync) {
    show.push(new Firework2(random(1000),random(height))); 
...
if(mostrarInter == true)
  ...
  if (millis() > sync) {
    show.push(new Firework5(random(1000),random(height))); 
  ...
  if (millis() > sync) {
    show.push(new Firework3(random(1000),random(height))); 
    sync = millis() + random(300,500);
    }
  }
  ...
  if (millis() > sync) {
    show.push(new Firework4(random(1000),random(height))); 
