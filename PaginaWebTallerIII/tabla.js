...
function setup() 
{
    ...
    sel.parent(P5Cristihan1);
    opcion="SUBA";

    sel1 = createSelect();
    sel1.position(1000, 300);
    sel1.option('SUBA');
    ...
    sel1.parent(P5Cristihan1);

    mensaje= createElement('h5', 'Compara cada localidad ');
   mensaje.parent(P5Cristihan1).position(1000,200);


   mensaje1= createElement('h5', 'Puedes cambiar entre ellas');
   mensaje1.parent(P5Cristihan1).position(1000,250);

    enero = createElement('h5', 'Enero');
    enero.parent(P5Cristihan1).position(840,580);

    febrero= createElement('h5', 'Febrero');
    febrero.parent(P5Cristihan1).position(840,530);

    marzo= createElement('h5', 'Marzo');
    marzo.parent(P5Cristihan1).position(840,480);
    abril= createElement('h5', 'Abril');
    abril.parent(P5Cristihan1).position(840,430);
    mayo= createElement('h5', 'Mayo');
    mayo.parent(P5Cristihan1).position(840,380);
    junio= createElement('h5', 'Junio');
    junio.parent(P5Cristihan1).position(840,330);
    julio= createElement('h5', 'Julio');
    julio.parent(P5Cristihan1).position(840,280);
    agosto= createElement('h5', 'Agosto');
    agosto.parent(P5Cristihan1).position(840,230);
    septiembre= createElement('h5', 'Septiembre');
    septiembre.parent(P5Cristihan1).position(840,180);
    octubre= createElement('h5', 'Octubre');
    octubre.parent(P5Cristihan1).position(840,130);
    noviembre= createElement('h5', 'Noviembre');
    noviembre.parent(P5Cristihan1).position(840,80);
    diciembre= createElement('h5', 'Diciembre');
   diciembre.parent(P5Cristihan1).position(840,30);
