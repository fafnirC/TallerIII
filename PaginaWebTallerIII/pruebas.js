...
function preload() 
{
  ...
  //tablaDeCadaLocalidad.parent(P5Cristihan1);
  fuente = loadFont('assets/TheFrontman.ttf');
  fuente.parent(P5Cristihan1);
  img = loadImage('assets/rock.png');
  img .parent(P5Cristihan1);
}
function setup() {
  ...
  canvasCristihan=createCanvas(1500, 700);
  canvasCristihan.parent(P5Cristihan1);
  noStroke();
  /*
